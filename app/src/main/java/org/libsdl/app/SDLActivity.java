 ...
 * SDL Activity
 */
public class SDLActivity extends AbsActivity implements View.OnSystemUiVisibilityChangeListener {
    ...
    protected static ClipboardHandler mClipboardHandler;
    protected static Hashtable<Integer, Object> mCursors;
    protected static int mLastCursorID;
    protected static SDLGenericMotionListener mMotionListener;

    // This is what SDL runs in. It invokes SDL_main(), eventually
    protected static Thread mSDLThread;

    protected static SDLGenericMotionListener getMotionListener() {
        if (mMotionListener == null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                mMotionListener = new SDLGenericMotionListener();
            }
        }
    ...
    protected String getMainSharedObject() {
        String library = "libmedia.so";
        return getContext().getApplicationInfo().nativeLibraryDir + "/" + library;
    }

    // Load the .so
    public void loadLibraries() {
        SDL.loadLibrary("media");
    }
...
//        // Default system back button behavior.
    ...
    public static native int sdlPlayLocal(String mfp);
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if ((event.getSource() == InputDevice.SOURCE_MOUSE || event.getSource() == 12290) && SDLActivity.mSeparateMouseAndTouch) {
            ...
            SDLGenericMotionListener motionListener = SDLActivity.getMotionListener();
...
class SDLClipboardHandler implements ClipboardHandler, ClipboardManager.OnPrimaryClipChangedListener {
